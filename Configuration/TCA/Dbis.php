    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table' => 'tx_libconnect_domain_model_dbis',
                'foreign_table_where' => 'AND tx_libconnect_domain_model_dbis.pid=###CURRENT_PID### AND tx_libconnect_domain_model_dbis.sys_language_uid IN (-1,0)',
            ),
        ),
